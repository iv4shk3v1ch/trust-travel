...
import { searchPlaces } from '@/core/database/placesDatabase';
...
const PlaceSearch: React.FC<PlaceSearchProps> = ({ onPlaceSelect, selectedPlace }) => {
  ...
  useEffect(() => {
    const MOCK_PLACES: PlaceWithType[] = [
      { id: '1', name: 'Pizzeria Corallo', place_type_id: '1', place_type: { id: '1', slug: PLACE_CATEGORIES.RESTAURANT, name: 'Restaurant', description: '', icon: null, created_at: '' }, city: '', country: '', address: '', latitude: 0, longitude: 0, phone: null, website: null, working_hours: null, description: '', photo_urls: null, price_level: null, indoor_outdoor: null, avg_rating: null, review_count: null, verified: null, created_by: null, created_at: '', updated_at: '' },
      { id: '2', name: 'Blue Note Jazz Club', place_type_id: '2', place_type: { id: '2', slug: PLACE_CATEGORIES.MUSIC_VENUE, name: 'Music Venue', description: '', icon: null, created_at: '' }, city: '', country: '', address: '', latitude: 0, longitude: 0, phone: null, website: null, working_hours: null, description: '', photo_urls: null, price_level: null, indoor_outdoor: null, avg_rating: null, review_count: null, verified: null, created_by: null, created_at: '', updated_at: '' },
      { id: '3', name: 'Central Park', place_type_id: '3', place_type: { id: '3', slug: PLACE_CATEGORIES.PARK, name: 'Park', description: '', icon: null, created_at: '' }, city: '', country: '', address: '', latitude: 0, longitude: 0, phone: null, website: null, working_hours: null, description: '', photo_urls: null, price_level: null, indoor_outdoor: null, avg_rating: null, review_count: null, verified: null, created_by: null, created_at: '', updated_at: '' },
      { id: '4', name: 'Starbucks Coffee', place_type_id: '4', place_type: { id: '4', slug: PLACE_CATEGORIES.COFFEE_SHOP, name: 'Coffee Shop', description: '', icon: null, created_at: '' }, city: '', country: '', address: '', latitude: 0, longitude: 0, phone: null, website: null, working_hours: null, description: '', photo_urls: null, price_level: null, indoor_outdoor: null, avg_rating: null, review_count: null, verified: null, created_by: null, created_at: '', updated_at: '' },
      { id: '5', name: 'Metropolitan Museum', place_type_id: '5', place_type: { id: '5', slug: PLACE_CATEGORIES.MUSEUM, name: 'Museum', description: '', icon: null, created_at: '' }, city: '', country: '', address: '', latitude: 0, longitude: 0, phone: null, website: null, working_hours: null, description: '', photo_urls: null, price_level: null, indoor_outdoor: null, avg_rating: null, review_count: null, verified: null, created_by: null, created_at: '', updated_at: '' },
      { id: '6', name: 'The Ritz Hotel', place_type_id: '6', place_type: { id: '6', slug: PLACE_CATEGORIES.HOTEL, name: 'Hotel', description: '', icon: null, created_at: '' }, city: '', country: '', address: '', latitude: 0, longitude: 0, phone: null, website: null, working_hours: null, description: '', photo_urls: null, price_level: null, indoor_outdoor: null, avg_rating: null, review_count: null, verified: null, created_by: null, created_at: '', updated_at: '' },
      { id: '7', name: 'Beach Bar Sunset', place_type_id: '7', place_type: { id: '7', slug: PLACE_CATEGORIES.BAR, name: 'Bar', description: '', icon: null, created_at: '' }, city: '', country: '', address: '', latitude: 0, longitude: 0, phone: null, website: null, working_hours: null, description: '', photo_urls: null, price_level: null, indoor_outdoor: null, avg_rating: null, review_count: null, verified: null, created_by: null, created_at: '', updated_at: '' },
      { id: '8', name: 'St. Peter\'s Basilica', place_type_id: '8', place_type: { id: '8', slug: PLACE_CATEGORIES.RELIGIOUS_SITE, name: 'Religious Site', description: '', icon: null, created_at: '' }, city: '', country: '', address: '', latitude: 0, longitude: 0, phone: null, website: null, working_hours: null, description: '', photo_urls: null, price_level: null, indoor_outdoor: null, avg_rating: null, review_count: null, verified: null, created_by: null, created_at: '', updated_at: '' },
    ];
  ...
  const handlePlaceSelect = (place: PlaceWithType) => {
    onPlaceSelect({
      id: place.id,
      name: place.name,
      category: (place.place_type?.slug || 'restaurant') as PlaceCategory
    });
          ...
          {searchResults.map((place) => (
            ...
            >
              ...
              <div className="text-sm text-gray-500 dark:text-gray-400">
                {getCategoryDisplayName((place.place_type?.slug || 'restaurant') as PlaceCategory)}
              </div>
            </button>
          ))}
        </div>
